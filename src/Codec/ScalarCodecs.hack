...
class ScalarCodecs
{
    ...
    const dict<string, string> KNOWN_TYPES = dict[
        '000000000000-0000-0000-000000000001' => 'anytype',
        '000000000000-0000-0000-000000000002' => 'anytuple',
        '000000000000-0000-0000-0000000000f0' => 'std',
        '000000000000-0000-0000-0000000000ff' => 'empty-tuple',
        '000000000000-0000-0000-000000000100' => 'std::uuid',
        '000000000000-0000-0000-000000000101' => 'std::str',
        '000000000000-0000-0000-000000000102' => 'std::bytes',
        '000000000000-0000-0000-000000000103' => 'std::int16',
        '000000000000-0000-0000-000000000104' => 'std::int32',
        '000000000000-0000-0000-000000000105' => 'std::int64',
        '000000000000-0000-0000-000000000106' => 'std::float32',
        '000000000000-0000-0000-000000000107' => 'std::float64',
        '000000000000-0000-0000-000000000108' => 'std::decimal',
        '000000000000-0000-0000-000000000109' => 'std::bool',
        '000000000000-0000-0000-00000000010a' => 'std::datetime',
        '000000000000-0000-0000-00000000010b' => 'std::local_datetime',
        '000000000000-0000-0000-00000000010c' => 'std::local_date',
        '000000000000-0000-0000-00000000010d' => 'std::local_time',
        '000000000000-0000-0000-00000000010e' => 'std::duration',
        '000000000000-0000-0000-00000000010f' => 'std::json',
        '000000000000-0000-0000-000000000110' => 'std::bigint',
    ];
